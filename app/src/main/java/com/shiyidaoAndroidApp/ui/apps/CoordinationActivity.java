...
import com.shiyidaoAndroidApp.databinding.ActivityCoordinationBinding;
import com.shiyidaoAndroidApp.ui.apps.fragment.MyTAskFragment;
import com.shiyidaoAndroidApp.ui.apps.fragment.NewTaskFragment;
...
public class CoordinationActivity extends BaseActivity {
    private ActivityCoordinationBinding binding;
    ...
    protected void initTitle() {
        titleBar.setTitle(getResources().getString(R.string.work_coordination));
    }

    @Override
    protected void initBinding() {
      binding=setContenteView(R.layout.activity_coordination);
        initImageView();
        initVPager();
    ...
    private void initVPager() {
        ...
        binding.viewpager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                // 当前Tab的字体变色
                titles[position].setTextColor(ContextCompat.getColor(CoordinationActivity.this,R.color.colorAccent));
                titles[current_index].setTextColor(ContextCompat.getColor(CoordinationActivity.this,R.color.notice_items_offText));
