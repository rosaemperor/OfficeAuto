...
public class OkHttpClientManager {
    ...
    private Request buildPostFormRequest(String url, Param[] params, Object tag) {
        ...
        reqBuilder.url(url)
                .post(requestBody)
        .build();
//                .addHeader("device", AppInfoUtile.getInstance(Application.getApplication()).getIMEICode())

//                .addHeader("token", Application.getApplication().getUserInfoEntity() == null ? "" : Application.getApplication().getUserInfoEntity().getToken())
//                .addHeader("uid", Application.getApplication().getUserInfoEntity() == null ? "0" : "" + Application.getApplication().getUserInfoEntity().getUserId())
//
//                .addHeader("source", "android");
//
//        LogUitl.E(TAG,  (Application.getApplication().getUserInfoEntity() == null ? "" : "" + Application.getApplication().getUserInfoEntity().getToken()) + "");
//        LogUitl.E(TAG,  (Application.getApplication().getUserInfoEntity() == null ? "0" : "" + Application.getApplication().getUserInfoEntity().getUserId())+"");
    ...
    public static class Param {
        ...
        public Param(String key, Boolean flag) {
            this.key=key;
            this.flag=flag;
        }
    }
    ...
    public class PostDelegate {
        ...
        public void postAsyn(String url, Param[] params, final ResultCallback callback, Object tag) {
            Request request = buildPostFormRequest(url, params, tag);
            Log.d("URL1", request.url().toString());
...
//            LogUitl.E(TAG, "TOKEN:" + Application.getApplication().getUserInfoEntity() == null ? "" : "" + Application.getApplication().getUserInfoEntity().getToken());
//            LogUitl.E(TAG, "UID" + Application.getApplication().getUserInfoEntity() == null ? "0" : "" + Application.getApplication().getUserInfoEntity().getUserId());

            if (tag != null) {
                builder.tag(tag);
            }
            Log.d("URL232", builder.build().toString());
            ...
            call.enqueue(new Callback() {
                ...
                public void onResponse(Response response) {
                    ...
                    try {
                        ...
                        fos = new FileOutputStream(Environment.getExternalStorageDirectory().getAbsolutePath()+file);
